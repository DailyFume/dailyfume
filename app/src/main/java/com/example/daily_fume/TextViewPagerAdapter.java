...
public class TextViewPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        TextView textView4 = view.findViewById(R.id.fume_title_01);
        TextView textView5 = view.findViewById(R.id.fume_title_02);
        TextView textView6 = view.findViewById(R.id.fume_title_03);
